        ...
        <BaseModal isOpen={isOpen} onClose={onClose}>
            ...
            >
                <div className="flex flex-col">
                    <Label name="name" className="text-slate-900">
                        Product name
                    </Label>
                    <TextField
                        name="name"
                        className="w-full border border-solid border-slate-200 rounded-lg px-4 py-2 focus:outline focus:outline-2 focus:outline-emerald-600"
                        validation={{
                            required: {
                                value: true,
