...
const AdminNavLayout = ({ children }: AdminNavLayoutProps) => {
    ...
    const navigation = {
        dashboard: {
            name: 'Dashboard',
            href: routes.admin({ tab: 'dashboard' }),
            current: false,
        },
        users: {
            name: 'Users',
            href: routes.adminUsers({ tab: 'users' }),
            current: false,
        },
        products: {
            name: 'Products',
            href: routes.adminProducts({ tab: 'products' }),
            current: false,
        },
        images: {
            name: 'Images',
            href: routes.adminImages({ tab: 'images' }),
            current: false,
        },
        markers: {
            name: 'Markers',
            href: routes.adminMarkers({ tab: 'markers' }),
            current: false,
        },
    }

    if (navigation.hasOwnProperty(tab)) {
        navigation[tab].current = true
    }
                                ...
                                <div className="border-t border-gray-700 pb-3 pt-4">
                                    ...
                                    <div className="mt-3 space-y-1 px-2">
                                        <Disclosure.Button
                                            as="button"
                                            onClick={logOut}
                                            className="block w-full rounded-md px-3 py-2 text-base font-medium text-gray-900  hover:bg-gray-700 hover:text-white"
                                        >
                                            logout
                                        </Disclosure.Button>
                                    </div>
